  ...
  <form:form id="registerForm" modelAttribute="p" method="post" action="update">
   <table width="400px" height="150px">
    <tr>
     ...
     <td><form:input path="id" value="${pObject.id}" disabled="true"/>
     </td>
    </tr>
    <tr>
     <td><form:label path="productname">Productname</form:label>
     </td>
     <td><form:input path="productname" value="${pObject.productname}" />
     </td>
    </tr>
    <tr>
     <td><form:label path="description">Description</form:label>
     </td>
     <td><form:input path="description" value="${pObject.description}"  />
     </td>
    </tr>
    <tr>
     <td><form:label path="price">Price</form:label>
     </td>
     <td><form:input path="price" value="${pObject.price}"/>
     </td>
    </tr>
    <tr>
     <td></td>
